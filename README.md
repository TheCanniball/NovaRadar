...
| Scanner | Settings |
|---------|----------|
| ![Scanner](docs/scanner.png) | ![Settings](docs/settings.png) |

## Download

Get the latest build from the [Releases](https://github.com/IRNova/Nova-Radar/releases) page.
...
```bash
# Clone the repo
git clone https://github.com/IRNova/Nova-Radar.git
cd Nova-Radar
...
go build -ldflags="-H windowsgui -s -w" -o NovaRadar.exe .

# Or build without console window
go build -ldflags="-H windowsgui" -o NovaRadar.exe .
```
